            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'testsiif.usac.edu.gt')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=usac,dc=edu,dc=gt'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'uid=Manager,dc=usac,dc=edu,dc=gt'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'secret'),
